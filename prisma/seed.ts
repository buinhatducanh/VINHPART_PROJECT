...
const products = [
    // ========== DÀN MÁY ĐIỆN ==========
    {
        ...
        sku: 'E001',
        stock: 50,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/den-pha-led-m5.jpg'],
        categoryId: 'lights',
        brand: 'M5',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'E002',
        stock: 80,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/den-xi-nhan-led.jpg'],
        categoryId: 'lights',
        brand: 'Generic',
        isActive: true,
        isFeatured: false,
    },
    {
        ...
        sku: 'E003',
        stock: 35,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/den-hau-led.jpg'],
        categoryId: 'lights',
        brand: 'Generic',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'E004',
        stock: 45,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/acquy-gs.jpg'],
        categoryId: 'battery',
        brand: 'GS',
        isActive: true,
        isFeatured: false,
    },
    {
        ...
        sku: 'E005',
        stock: 20,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/acquy-lithium.jpg'],
        categoryId: 'battery',
        brand: 'Lithium Pro',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'E006',
        stock: 15,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/day-dien-winner.jpg'],
        categoryId: 'wiring',
        brand: 'Honda',
        isActive: true,
        isFeatured: false,
    ...
    // ========== HỆ THỐNG PHANH ==========
    {
        ...
        sku: 'B001',
        stock: 60,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/ma-phanh-honda.jpg'],
    ...
    },
    {
        ...
        sku: 'B002',
        stock: 40,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/ma-phanh-racing-boy.jpg'],
        categoryId: 'brake-pads',
        brand: 'Racing Boy',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'B003',
        stock: 100,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/dau-phanh-motul.jpg'],
    ...
    },
    {
        ...
        sku: 'B005',
        stock: 25,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/dia-phanh-brembo.jpg'],
    ...
    // ========== ĐỘNG CƠ ==========
    {
        ...
        sku: 'M001',
        stock: 20,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/xi-lanh-piston.jpg'],
        categoryId: 'piston',
        brand: 'STD Racing',
        isActive: true,
        isFeatured: false,
    },
    {
        ...
        sku: 'M002',
        stock: 30,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/piston-takasago.jpg'],
        categoryId: 'piston',
        brand: 'Takasago',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'M003',
        stock: 35,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/loc-gio-dna.jpg'],
    ...
    },
    {
        ...
        sku: 'M005',
        stock: 200,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/dau-nhot-motul.jpg'],
        categoryId: 'oil',
        brand: 'Motul',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'M006',
        stock: 180,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/dau-nhot-shell.jpg'],
        categoryId: 'oil',
        brand: 'Shell',
        isActive: true,
        isFeatured: false,
    },
    {
        ...
        sku: 'M007',
        stock: 150,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/dau-nhot-castrol.jpg'],
        categoryId: 'oil',
        brand: 'Castrol',
        isActive: true,
        isFeatured: false,
    ...
    // ========== HỆ THỐNG TRUYỀN ĐỘNG ==========
    {
        ...
        sku: 'T001',
        stock: 18,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/nhong-sen-dia-did.jpg'],
    ...
    },
    {
        ...
        sku: 'T002',
        stock: 25,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/sen-rk-racing.jpg'],
        categoryId: 'chain-sprocket',
        brand: 'RK Racing',
        isActive: true,
        isFeatured: false,
    },
    {
        ...
        sku: 'T003',
        stock: 22,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/ly-hop-winner.jpg'],
        categoryId: 'clutch',
        brand: 'Honda',
        isActive: true,
        isFeatured: false,
    ...
    // ========== BÁNH XE & LỐP ==========
    {
        ...
        sku: 'W001',
        stock: 50,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/lop-michelin.jpg'],
        categoryId: 'tires',
        brand: 'Michelin',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'W002',
        stock: 40,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/lop-dunlop.jpg'],
        categoryId: 'tires',
        brand: 'Dunlop',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'W004',
        stock: 8,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/mam-brembo.jpg'],
        categoryId: 'rims',
        brand: 'Brembo',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'W005',
        stock: 12,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/mam-racing-boy.jpg'],
        categoryId: 'rims',
        brand: 'Racing Boy',
        isActive: true,
        isFeatured: false,
    ...
    // ========== PHỤ KIỆN ==========
    {
        ...
        sku: 'A001',
        stock: 10,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/phuoc-yss.jpg'],
    ...
    },
    {
        ...
        sku: 'A002',
        stock: 5,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/phuoc-ohlins.jpg'],
        categoryId: 'suspension',
        brand: 'Ohlins',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'A003',
        stock: 8,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/po-akrapovic.jpg'],
        categoryId: 'exhaust',
        brand: 'Akrapovic',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'A004',
        stock: 10,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/po-yoshimura.jpg'],
        categoryId: 'exhaust',
        brand: 'Yoshimura',
        isActive: true,
        isFeatured: false,
    },
    {
        ...
        sku: 'A006',
        stock: 15,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/guong-rizoma.jpg'],
        categoryId: 'mirrors',
        brand: 'Rizoma',
        isActive: true,
        isFeatured: true,
    },
    {
        ...
        sku: 'A007',
        stock: 30,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/guong-cnc.jpg'],
        categoryId: 'mirrors',
        brand: 'CNC',
        isActive: true,
        isFeatured: false,
    },
    {
        ...
        sku: 'A008',
        stock: 25,
        images: ['https://res.cloudinary.com/dmz66rbbk/image/upload/v1/vinhpart/guong-koso.jpg'],
        categoryId: 'mirrors',
        brand: 'KOSO',
        isActive: true,
        isFeatured: false,
