                ...
                <div className="relative p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-bold py-3 rounded-lg transition-all shadow-lg shadow-red-600/30 hover:shadow-red-600/50 mt-6"
                    >
                      {mode === 'login' ? 'Đăng nhập' : 'Đăng ký'}
                    </motion.button>
                  </form>
