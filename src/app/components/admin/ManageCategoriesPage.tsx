    ...
    return (
      <div key={category.id}>
        <motion.div
          ...
          className={`group flex items-center gap-3 p-4 bg-gray-800/30 hover:bg-gray-800/50 border border-gray-800 rounded-lg transition-all ${
            level > 0 ? 'ml-' + (level * 8) : ''
          }`}
        ...
        >
          ...
          <div className={`w-10 h-10 bg-gradient-to-br ${
            level === 0 ? 'from-orange-600 to-orange-800' :
