            ...
            <div className="space-y-4 text-gray-300">
                <div className="space-y-3">
                    <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <p className="text-sm">
                                Có. Tất cả sản phẩm tại AutoParts đều là hàng chính hãng, có tem bảo hành và CO/CQ đầy đủ. Chúng tôi cam kết hoàn tiền 200% nếu phát hiện hàng giả.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <p className="text-sm">
                                Bạn có thể sử dụng bộ lọc tìm kiếm theo hãng xe và model. Hoặc liên hệ hotline <span className="text-red-500 font-bold"> 1900 xxxx </span> để được tư vấn miễn phí từ kỹ thuật viên chuyên nghiệp.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <p className="text-sm">
                                Có. Chúng tôi có đội ngũ kỹ thuật viên sẵn sàng đến tận nơi lắp đặt cho các sản phẩm phức tạp. Phí dịch vụ từ 100.000đ tùy khu vực và loại sản phẩm.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <p className="text-sm">
                                Có. Bạn được đổi trả miễn phí trong vòng 30 ngày nếu sản phẩm chưa sử dụng, còn nguyên tem mác. Xem chi tiết tại mục <span className="text-red-500 font-semibold"> Chính sách đổi trả </span>.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <p className="text-sm">
                                Mỗi sản phẩm có mã tem bảo hành riêng. Bạn có thể tra cứu trên website hoặc gọi hotline để kiểm tra thông tin bảo hành và thời gian còn lại.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4">
                    ...
                    <div className="flex flex-col gap-1 text-sm">
                        ...
                        <span>✉️ Email: <span className="text-white font-semibold"> support@autoparts.vn</span></span>
                    </div>
                </div>
            </div>
        ),
