import { Package, ShoppingCart, Folder, Plus, ClipboardList, Edit, FileText, MessageSquare, Layers, Shield, Layout } from 'lucide-react';
...
export const QUICK_ACTIONS_CONFIG: QuickActionConfig[] = [
    ...
    { key: 'manageHomepageSections', label: 'Quản lý trang chủ', icon: Layout, color: 'text-indigo-400', hoverColor: 'hover:bg-indigo-500/10', targetPage: 'manageHomepageSections' },
];
