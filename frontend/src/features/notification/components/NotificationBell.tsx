                ...
                {isOpen && (
                    ...
                    >
                        <div className="p-4 border-b border-gray-800 flex justify-between items-center bg-black/40">
                            ...
                            <span className="text-xs text-gray-500">{unreadCount} đơn hàng mới</span>
                        </div>
                                ...
                                notifications.map((notif) => (
                                    ...
                                    >
                                        <div className="flex gap-3">
                                            <div className="w-10 h-10 bg-red-600/20 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-red-600 transition-colors">
