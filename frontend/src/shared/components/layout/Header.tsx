...
interface HeaderProps {
  ...
  onAdminClick?: () => void;
  onOpenAuth?: (mode?: 'login' | 'signup' | 'forgot' | 'reset') => void;
}
...
export function Header({ 
  ...
  // Check for reset token in URL (for header)
  useEffect(() => {
                      ...
                      {user ? (
                        ...
                        <>
                          ...
                          <button
                            ...
                            className="w-full px-4 py-3 text-left hover:bg-muted transition-colors text-muted-foreground text-sm"
                          >
                  ...
                  {user ? (
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <button
                        ...
                        className="w-full py-2 px-4 text-sm text-muted-foreground hover:text-red-500 transition-colors"
                      >
                        {t('auth.forgotPassword') || 'Forgot Password?'}
                      </button>
                    </div>
